  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "You'll receive the latest AI automation insights and case studies."
      });
      setEmail("");
    ...
    <section id="newsletter" className="bg-white py-0">
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-5xl font-display font-bold mb-4 text-left">Get AI Automation Insights</h2>
          <p className="text-xl text-gray-700 mb-10 text-left">
            Join 5,000+ business leaders receiving weekly insights on AI automation trends, case studies, and proven strategies to scale your business.
          </p>
